<?php
/**
 * Returns the complete list of internationally recognized countries as
 * [ISO 3166-1 alpha-2 code => official/common name], sorted alphabetically
 * by name. Used everywhere a country <select> is rendered (signup, profile,
 * guest checkout) so the list only needs to be maintained in one place.
 */
